...
$id = $_SESSION['s_id'];
$profile_photo_query = "SELECT profile_photos FROM users WHERE id = '$id'";
$profile_photo_query_result = mysqli_query($db_connect, $profile_photo_query);
$profile_photo_assoc = mysqli_fetch_assoc($profile_photo_query_result);
$profile_photo = $profile_photo_assoc['profile_photos'];
        ...
        <div class="app-sidebar">
            <div class="logo">
                ...
                <div class="sidebar-user-switcher user-activity-online">
                    <a href="#">
                        <img src="uploads/profile_photo/<?=$profile_photo;?>" style="height:40px; width: 40px; border-radius: 50%;">
